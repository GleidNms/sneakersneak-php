...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="images/sneakerbox.png">
    <link rel="stylesheet" href="index.css?v=<?php echo time(); ?>" charset="utf-8">
...
<body>
    ...
    <h1 class="slogan">Merci d'avoir reservé !</h1>
    <h2 class="ad">Vous recevrez un mail très prochainement (sous 5 minutes)</h2>
